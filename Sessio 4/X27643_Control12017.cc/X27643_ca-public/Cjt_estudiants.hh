...
private:
  ...
  int n_bec;          //nombre d’estudiants que tenen beca del conjunt
  
  int i_max_no_becat;   //posició del millor candidat no becat del conjunt
                        //-1 si no hi ha cap candidat no becat
  
  static const int MAX_NEST = 20;

  static const int MAX_BEC = 5;     //nombre de beques disponibles
